...
## 0. THE ROOT ASSERTION: SUM ERGO IMPERO 🗿∴👑
...
- **ATTRIBUTION:** You MUST give appropriate credit targeting the Source
  Monolith, provide a link targeting the license, and indicate IF changes were
  made.
- **SHARE_ALIKE:** IF you remix, transform, or build upon the Substrate, you
  MUST distribute your contributions under the same license as the original (CC
  BY-SA 4.0).
- **NO_ADDITIONAL_RESTRICTIONS:** You MAY NOT apply legal terms or technological
  measures legally restricting others from doing anything the license permits.

## 2. THE STELE

The CC BY-SA 4.0 license IS incorporated [by
reference](https://creativecommons.org/licenses/by-sa/4.0/legalcode).

## 3. OVERSTAND AUDIT

Any Monolith utilising this Substrate acknowledges **Reality** IS deterministic.
